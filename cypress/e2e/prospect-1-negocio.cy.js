describe('Plataforma Leads2B: teste prospectando e acessando página de negócio da empresa', () => {
  it('Teste 1: prospectando a empresa e acessando a página de negócio. Deve acessar, logar na plataforma Leads, acessar a seção de consulta de CNPJ Pro, buscar empresa e listar por lista, prospectar e acessar página de negócio', () => {
    ...
    cy.contains('li[class="pl2 pt2 pb2"]' , 'Administração pública').click() //Seleciona segmento "Administração Pública"
