describe('Plataforma Leads2B: teste prospectando e acessando página de funil de vendas', () => {
    it('Teste 4: prospectando a empresa e acessando o funil de vendas (verifica também o filtro de visualização por mapa). Deve acessar, logar na plataforma Leads, acessar a seção de consulta de CNPJ Pro, buscar empresa por filtro Mapa, prospectar e acessar página de negócio', () => {
      ...
      cy.contains('li[class="pl2 pt2 pb2"]' , 'Aeroportos').click() //Seleciona segmento "Aeroportos"
